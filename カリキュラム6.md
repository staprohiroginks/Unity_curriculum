...
![ソリューション欄](./images/rider7.png)

その後`追加>クラス/インターフェース`をクリックします。

![](./images/image5-2.png)

すると画面が変わるので「構造体」を選択してください
![](./images/image6-2.png)

`名前`の欄に構造体の名前を入力します。
今回は`DataTestStruct`という名前を入力しエンターを押してください
...
![refの説明](./images/ref_no_shiyou.png)
